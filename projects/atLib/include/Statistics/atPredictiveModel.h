...
public:
  ...
  virtual bool Train(const atVector<double> &input, const atVector<double> &output) = 0;
  ...
  bool TrainBatch(const atVector<atVector<double>> &input, const atVector<atVector<double>> &output);
};
