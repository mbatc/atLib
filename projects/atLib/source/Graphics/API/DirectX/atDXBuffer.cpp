...
atDXBuffer::atDXBuffer(const atBufferType &type) : atGPUBuffer(type) {}
...
bool atDXBuffer::Upload()
{
  ...
  bool success = !FAILED(((ID3D11Device*)((atDirectX*)atGraphics::GetCurrent())->GetDevice())->CreateBuffer(&desc, size > 0 ? &data : nullptr, &pBuffer));
  m_pResource = pBuffer;
  return success;
}
